...
const AboutPage = () => {
  ...
  return (
    <main className="about-page">
      ...
      >
        <h1 id="header-title" className="fade-element">Discomfort might just be the cure</h1>
      </section>

      {/* Section 2 */}
      <section className="section founder-note" aria-labelledby="founder-title">
        <header>
          <h2 id="founder-title" className="fade-element">A brief note from the founders</h2>
        </header>
        <article className="fade-element">
          <p>
            We are M and V — both from a small corner of Europe known for some
            of the biggest waves ever surfed - Portugal. We are college
            sweethearts with a nerdy background in physics, who spent (too) many
            years in the corporate world. After years of living fast, we yearned
            to go back to basics and reconnect with nature - and with ourselves.
            <br />
            <br />
            While ocean dips were frequent back home (and the ocean can be
            cruelly cold), plunging into truly icy waters had a profound effect
            on us. Each time we emerged stronger—mentally sharper, physically
            more resilient, and emotionally more centered. Through these
            experiences we found that pushing our boundaries in the cold created
            a sense of clarity and empowerment that is hard to achieve anywhere
            else.
            <br />
            <br />
